...
class InferenceEngine:
    ...
    def __init__(self, class_labels, model_path='/home/pi',):
        self.mediapipe = mp.solutions.holistic.Holistic(min_detection_confidence = 0.5, min_tracking_confidence = 0.5)
    ...
    def mediapipe_detection(self):
        ...
        results = self.mediapipe.process(image)                 # Make prediction
    ...
    def tflite_predict(self):
        input_arr = np.array(np.expand_dims(self.sequence, axis=0),dtype=np.float32)
