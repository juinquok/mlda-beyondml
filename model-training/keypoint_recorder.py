...
# Set path for exported data, numpy arrays
DATA_PATH = os.path.join('medcine') 

# Define actions that we try 
actions = np.array(['giddy', 'few', 'months', 'uncomfortable', 'no', 'room', 'spin', 'allergic'])

# Define number of videos to record
no_sequences = 35

# Define number of frames for each video, videos are going to be 30 frames in length
sequence_length = 30
